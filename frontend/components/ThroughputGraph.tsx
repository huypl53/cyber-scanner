...
export function ThroughputGraph({ data, maxDataPoints = 30 }: ThroughputGraphProps) {
  const t = useTranslations('realtime.throughput');
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-center gap-6 mt-4 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground">{t('threatTraffic')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-3 w-3 rounded-full bg-status-safe shadow-glow-green" />
            <span className="text-muted-foreground">{t('normalTraffic')}</span>
          </div>
        </div>
      </CardContent>
    </Card>
